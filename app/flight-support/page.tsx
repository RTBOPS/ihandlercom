        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            {services.map((s) => (
              <div
                key={s.title}
                className="rounded-2xl border border-white/10 bg-white/[0.03] p-6 hover:border-[#F34707]/40 transition-colors"
              >
                <div className="text-3xl mb-3">{s.icon}</div>
                <h3 className="text-white font-semibold text-lg mb-4">{s.title}</h3>
          ...
          <div className="text-center rounded-2xl border border-[#F34707]/20 bg-[#F34707]/5 p-12">
            <h2 className="text-2xl font-bold text-white mb-3">Ready to simplify your operations?</h2>
